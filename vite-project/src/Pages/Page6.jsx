...
const Page6 = () => {
  return (
    ...
    <div className="flex items-center justify-between  flex-wrap">
        <h1 className="w-[152px] h-12 font-medium text-[32px] leading-[100%] tracking-[0%] align-middle ml-37 mt-9">Our Blogs</h1>
...
<div className="flex items-center justify-center gap-6 mt-9 flex-wrap">
 ...
 <div className="flex items-center gap-41 justify-around">
        <div className="flex items-center gap-2">
             <img src={img38} alt="" />
             <p className="font-light text-xs leading-[100%] tracking-[0%] text-[#9E9E9E]">August , 8 , 2023</p>
        </div>
    <div className="flex items-center gap-1">
             <img src={img39} alt="" />
             <p className="font-light text-xs leading-[100%] tracking-[0%] text-[#9E9E9E]">3 min read</p>
        </div>
 </div>
<h1 className=" text-xl mt-1">Meta Platforms plans to release free software that...</h1>
<p className="font-light text-base leading-6 tracking-[0%]">The parent company of Facebook, Meta Platforms, is introducing software to help developers </p>
      </div>
     </div>
  ...
  {/* Matn — responsive font va cheklov */}
  ...
  {/* Sana va tugma — responsive joylashuv */}
  <div className="flex items-center justify-between mt-4">
    <div className="flex items-center gap-2">
      <img src={img38} alt="Calendar" className="w-4 h-4" />
      <span className="font-light text-xs text-gray-500">March, 28, 2023</span>
    </div>
    <img src={img42} alt="Share" className="w-5 h-5" />
  </div>
</div>
