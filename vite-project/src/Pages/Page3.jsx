...
const PromoBanners = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center  lg:gap-21 p-4   ">
          ...
          <div className="flex gap-2">
            {Array(4)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="bg-white text-blue-900 text-xs font-bold px-2 py-1 rounded"
                >
                  8 Days
                </div>
              ))}
      ...
      <div
        className="bg-gradient-to-r max-w-[444px] h-82 from-yellow-500 to-orange-400 rounded-xl p-6 
