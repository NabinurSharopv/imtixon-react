...
const Shovkes = () => {
  return (
<div className="max-w-[1500px] m-auto flex flex-col md:flex-row items-center justify-between px-4 py-10 gap-10">
  <div className="grid gap-6 m-auto  md:text-left max-w-xl ml-24">
   ...
   <img src={img4}  className=" sm:w-130  md:w-[310px] lg:w-[728px] mt-[-39px] lg: w-[530px] mx-auto"/>
</div>
  )
}
